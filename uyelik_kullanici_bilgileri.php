        ...
        <div class="container">
            <div class="d-flex dflexprofilim">
                <div class="item_menu_1">
                    ...
                    <ul class="menu_item">
                        ...
                        <li class="menu_li">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                                <path d="M4.05469 17.9853L19.9761 2.06384" stroke="#F4F4F4" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M19.9773 9.02947V2.06384H13.0117" stroke="#F4F4F4" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M25.9449 12.0148L10.0234 27.9362" stroke="#F4F4F4" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M10.0234 20.9706V27.9362H16.9891" stroke="#F4F4F4" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                ...
                <div class="item_form_area">
                    <div class="web_input_group mt-4">
                        <h4 class="h4-sml">Bilgi Güncelleme</h4>
                        <form action="#" method="post">
                            <div class="form-group">
                                <input type="text" id="ad" name="ad" placeholder="Adınız" class="input_items" required>
                            </div>
                            <div class="form-group">
                                <input type="text" id="soyad" name="soyad" placeholder="Soyadınız" class="input_items" required>
                            </div>
                            <div class="form-group">
                                <input type="email" id="email" name="email" placeholder="E-Posta" class="input_items" required>
                            </div>
                            <div class="form-group">
                                <input type="phone" id="telefon" name="telefon" placeholder="Telefon" class="input_items" required>
                            </div>
                    ...
                    <div class="web_input_group mt-4 mb-4">
                        <h4 class="h4-sml">Şifre Güncelleme</h4>
                        <form action="#" method="post">
                            <div class="form-group">
                                <input type="password" id="eskisifre" name="eskisifre" placeholder="Eski Şifre*" class="input_items" required>
                            </div>
                            <div class="form-group">
                                <input type="password" id="yenisifre" name="yenisifre" placeholder="Yeni Şifre*" class="input_items" required>
                            </div>
                            <div class="form-group">
                                <input type="password" id="yenisifrecheck" name="yenisifrecheck" placeholder="Yeni Şifre Tekrar*" class="input_items" required>
                            </div>
                            <div class="form-group d-flex justify-content-center">
                                <button type="submit">Güncelle</button>
                            </div>
