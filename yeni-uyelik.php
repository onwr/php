    ...
    <section  class="uyelik" style="background-image:url('assets/image/uyelik/bg-1.jpg'); background-size:cover;">
        <div class="container">
            <div class="web_input_group">
                <h4 class="h4-sml">Yeni Üyelik</h4>
                <form action="#" method="post">
                    ...
                    <div class="form-group">
                        <input type="telefon" id="telefon" name="telefon" placeholder="Telefon*" class="input_items" required>
                    </div>
                    <div class="form-group">
                    <input type="password" id="password" name="password" placeholder="Şifre" class="input_items" required>
                    </div>
                    <div class="form-group">
                        <input type="password" id="password_re" name="password_re" placeholder="Şifre Tekrar" class="input_items" required>
                    </div>
                    <div class="form-group d-flex flex-lg-row flex-column justify-content-between">
                        <div class="checkbox">
                            <label for="remember-me">(*) İşaretli alanların doldurulması zorunludur!</label>
                        </div>
                    </div>
                    <div class="form-group d-flex justify-content-center">
                        <button type="submit">Üye Ol</button>
                    </div>
                    <div class="form-group d-flex justify-content-center"">Üye misiniz? <a href="giris-yap.php" title="Hemen Giriş Yap">Hemen Giriş Yap</a></div>
                </form>
            </div>
        </div>
    </section>
