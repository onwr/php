...
<body>
    ...
    <section class="profilim_bilgiler favori_ilanlar aramalar">
        <div class="container">
            <div class="d-flex">
                ...
                <div class="item_form_area">
                    <h4 class="h4-sml">Favori Aramalar</h4>
                    <div class="row mt-4">
                        <div class="col-sm-9 col-6 title_area ta_1">
                            <div class="title">AÇIKLAMA</div>
                        </div>
                        <div class="col-sm-3 col-6 title_area ta_2 text-sm-center text-end">
                            <div class="title">İŞLEM</div>
                        </div>
                        <div class="col-9 bright">
                                <div class="list_area">
                                    <div class="text_item">
                                        <h5 class="s3">Lorem ipsum dolor sit ametconsectetur pellentesque.</h5>
                                    </div>
                                </div>  
                        </div>
                        <div class="col-3 text-center d-flex justify-content-center align-items-center bleft flex-column">
                                <div class="d-flex item_site">    
                                    <div class="text">E-Posta Bildirimi</div>
                                    <label class="switch">
                                        <input type="checkbox">
                                        <span class="sliderss round"></span>
                                    </label>
                                </div>
                                <a href="#" class="sil_button" title="Sil">
                        ...
                        <div class="col-9 bright last-radius">
                                <div class="list_area">
                                    <div class="text_item">
                                        <h5 class="s3">Lorem ipsum dolor sit ametconsectetur pellentesque.</h5>
                                    </div>
